...
import { CheckoutDto, ReturnDto, SaleQueryDto, VoidSaleDto } from '../../application/dtos/sales.dto.js';
...
export class SalesController {
  ...
  @ApiQuery({ name: 'status', required: false, enum: ['COMPLETED', 'VOID', 'RETURNED', 'PARTIAL_RETURN'] })
